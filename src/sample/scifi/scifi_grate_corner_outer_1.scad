...
scifi_grate_corner_outer_1();

module scifi_grate_corner_outer_1() {
	girl_tile();
	...
	mirror_copy([1,1])
	translate([-(grid_size-wall_width)/2,-wall_width/2,tile_height-0.01])
		_scifi_floor_grate([wall_width,grid_size-wall_width]);
