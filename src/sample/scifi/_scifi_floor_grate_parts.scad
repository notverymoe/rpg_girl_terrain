...
module _scifi_floor_grate(size = tile_size, frame_w = 2.5) {
...
module _scifi_floor_grate_sheet(size = tile_size, thickness = 0.5) {
	w = is_num(size) ? size : size[0];
	h = is_num(size) ? size : size[1];
...
module _scifi_floor_grate_frame(size = tile_size, thickness = 2.5) {
	w = is_num(size) ? size : size[0];
	h = is_num(size) ? size : size[1];
